...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { name: @faculty.name, users_id: @faculty.users_id } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { name: @faculty.name, users_id: @faculty.users_id } }
